...
Usuario.prototype.excluirDados = function(id, callback){
   this._conexao.query(`delete * from usuario where id = ${id}`, callback)
} 

Usuario.prototype.alterar = function(dados, id, callback){
    this._conexao.query(`update usuario set nome = '${dados.nome}', senha = '${dados.senha}', id_tipo_usuario = '${dados.id_tipo_usuario}' where id = ${id}`, callback)
}
    Usuario.prototype.excluir = function(dados, id, callback){
       this._conexao.query(`update usuario set nome = '${dados.nome}', email ='${dados.email}', senha ='${dados.senha}', id_tipo_usuario ='${dados.id_tipo_usuario}'where id = ${id}`, callback)
   }
