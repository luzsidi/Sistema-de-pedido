...
module.exports.cadastrar= function(app, request, response){
    ...
    //request.assert('alterar_dados','Você pode alterar dados').notEmpty();
    //request.assert('alterar_senha','Você pode alterar senha').notEmpty();
...
module.exports.validar = function (app, request, response){
    ...
    request.assert('senha', 'Você pode alterar senha').notEmpty();
...
//module.exports.alterar_senha = function(app, request, response){  
  // const conexao = app.config.conexao;
 // const modelUsuario =new app.app.models.modelUsuario(conexao);

   //modelUsuario.alterar_senha(function(error, result) {
      // response.render('usuario/alterar_senha', { usuarios: result}) 
